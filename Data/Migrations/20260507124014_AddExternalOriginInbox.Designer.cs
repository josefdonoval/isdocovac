...
namespace Isdocovac.Data.Migrations
{
    ...
    [Migration("20260507124014_AddExternalOriginInbox")]
    partial class AddExternalOriginInbox
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Isdocovac.Models.Email.EmailIngestionMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("MailboxAccountId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("MailboxAccountId", "MessageId")
                        .IsUnique();

                    b.ToTable("email_ingestion_messages");
                });

            modelBuilder.Entity("Isdocovac.Models.Email.MailboxAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("ProcessedFolderName")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)");
                    ...
                    b.HasIndex("CompanyId", "Enabled");

                    b.ToTable("mailbox_accounts");
                });
            ...
            modelBuilder.Entity("Isdocovac.Models.Inbox.ExternalOriginFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("EmailIngestionMessageId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("IsInvoiceCandidate")
                        .HasColumnType("boolean");
                    ...
                    b.HasIndex("EmailIngestionMessageId");

                    b.HasIndex("ParsedInvoiceId");

                    b.HasIndex("CompanyId", "Status", "CreatedAt");

                    b.ToTable("external_origin_files");
                });
            ...
            modelBuilder.Entity("Isdocovac.Models.Email.EmailIngestionMessage", b =>
                {
                    b.HasOne("Isdocovac.Models.Email.MailboxAccount", "MailboxAccount")
                        .WithMany()
            ...
            modelBuilder.Entity("Isdocovac.Models.Inbox.ExternalOriginFile", b =>
                {
                    ...
                    b.HasOne("Isdocovac.Models.Email.EmailIngestionMessage", "EmailIngestionMessage")
                        .WithMany()
                        .HasForeignKey("EmailIngestionMessageId")
                    ...
                    b.Navigation("EmailIngestionMessage");
