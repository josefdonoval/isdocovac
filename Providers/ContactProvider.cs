...
public interface IContactProvider
{
    ...
    Task<IReadOnlyList<Contact>> ListDirectoryAsync(Guid userId);
...
public class ContactProvider : IContactProvider
{
    ...
    public async Task<IReadOnlyList<Contact>> ListDirectoryAsync(Guid userId)
    {
        return await _context.Contacts
            .Where(c => c.UserId == userId && c.Kind != ContactKind.OwnCompany)
